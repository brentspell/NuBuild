...
namespace NuBuild.VS
{
    ...
    public sealed class NuBuildPropertyPage : SettingsPage
    {
        ...
        private Boolean recompileReferances;
        ...
        /// </summary>
        [Category("Advanced")]
        [DisplayName("Auto Generate Nuget Dependencies")]
        ...
        /// <summary>
        /// Recompile all referanced projects
        /// </summary>
        [Category("Advanced")]
        [DisplayName("Recompile Referances")]
        [Description(@"Recompile all referanced projects.")]
        public Boolean RecompileReferances
        {
            get { return this.recompileReferances; }
            set { this.recompileReferances = value; this.IsDirty = true; }
        }
        ...
        protected override void BindProperties()
        {
            ...
            this.recompileReferances = Boolean.Parse(
                this.ProjectMgr.GetProjectProperty("NuBuildRecompileReferances")
            );
        ...
        protected override Int32 ApplyChanges()
        {
            ...
            this.ProjectMgr.SetProjectProperty(
               "NuBuildRecompileReferances",
               this.recompileReferances.ToString()
            );
            this.ProjectMgr.SetProjectProperty(
               "NuBuildIncludePdbs",
