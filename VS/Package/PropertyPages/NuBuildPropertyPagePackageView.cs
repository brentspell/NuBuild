...
namespace NuBuild.VS
{
   ...
   partial class NuBuildPropertyPagePackageView : PageView
   {
      ...
      public const string AutoGenerateDependenciesRecursivelyPropertyTag = "NuBuildAutoGenerateDependenciesRecursively";
      ...
      protected override PropertyControlTable PropertyControlTable
      {
         get
         {
            if (propertyControlTable == null)
            {
               ...
               propertyControlTable.Add(AutoGenerateDependenciesRecursivelyPropertyTag, chkAutoGenerateDependenciesRecursively);
